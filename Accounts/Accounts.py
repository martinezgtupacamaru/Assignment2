...
class Account:
    ...
    def __init__(self, start_balance: int, current_balance: int, total_deposit: int, number_deposit: int,  total_withdrawal: int, number_withdrawal: int, annual_interest_rate: int, monthly_service_charge: int, account_status):
...
class Savings (Account):
    ...
    def withdrawal(self, amount):
        if self.account_status and self.current_balance - amount < 25:
            ...
            print("The balance of this account is less than 25, the account is now inactive")
...
class Checking (Account):
    ...
    def withdrawal(self, amount):
        if self.current_balance <= 0:
            ...
            self.monthly_service_charge += 15
            print("The withdrawal cannot be made due to insufficient funds")
            # print("The balance of your Checking account is now negative")
            # super().withdrawal(amount)
    ...
    def close_month(self):
        self.monthly_service_charge += 5 + (self.number_withdrawal*0.10)
        super().close_month()
